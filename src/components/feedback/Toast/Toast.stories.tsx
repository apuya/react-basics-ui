...
export const SaveConfirmation: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Example of a save confirmation toast.',
      },
    },
  },
};
...
export const DeleteWarning: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Example of a deletion warning toast.',
      },
    },
  },
};
...
export const NetworkError: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Example of a network error toast with close button.',
      },
    },
  },
};
...
export const UpdateAvailable: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Example of an update notification toast.',
      },
    },
  },
};
...
export const UploadProgress: Story = {
  args: {
    variant: 'default',
    title: 'Uploading...',
    description: '3 files are being uploaded to the server.',
  },
  parameters: {
    docs: {
      description: {
        story: 'Example of an upload progress toast.',
      },
    },
  },
};
...
export const InvitationSent: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Example of an invitation confirmation toast.',
      },
    },
  },
};
...
export const PermissionDenied: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Example of a permission denied error toast.',
      },
    },
  },
};
...
export const SessionExpiring: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Example of a session expiration warning toast.',
      },
    },
  },
};
...
export const NewMessage: Story = {
  args: {
    variant: 'info',
    title: 'New Message',
    description: 'Sarah sent you a message: "Are you free for a call?"',
    onClose: () => console.log('Message dismissed'),
  },
  parameters: {
    docs: {
      description: {
        story: 'Example of a new message notification toast.',
      },
    },
  },
};
