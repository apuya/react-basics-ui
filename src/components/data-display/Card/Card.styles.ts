...
export const FOOTER_CLASSES = 'flex items-center border-t border-[var(--component-card-border)]';
...
export const DESCRIPTION_CLASSES = 'text-[length:var(--component-card-description-size)] font-[var(--component-card-description-weight)] text-[var(--semantic-text-secondary)] mt-1';
