...
export const NODE_CONTENT_BASE_CLASSES =
  'flex items-center rounded cursor-pointer transition-colors duration-200 hover:bg-[color:var(--component-tree-node-bg-hover)]';
...
export const TOGGLE_BUTTON_CLASSES =
  'inline-flex items-center justify-center size-4 text-[color:var(--component-tree-toggle-color)] transition-transform duration-200 shrink-0';
...
export const NODE_ICON_CLASSES =
  'inline-flex items-center justify-center size-4 text-[color:var(--component-tree-icon-color)] shrink-0';
