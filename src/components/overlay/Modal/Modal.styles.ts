...
export const MODAL_BASE_CLASSES =
  'relative bg-[color:var(--component-modal-bg)] text-[color:var(--component-modal-text)] rounded-lg shadow-lg border border-[color:var(--component-modal-border)] max-h-[90vh] flex flex-col opacity-0 scale-95 transition-all duration-300';
